...
^1^ Line ending: The challenge emphasize the line ending issue. I have not implemented it as vertx handlers abstracts this logic. As mentioned on repo's readme, I have not taken the Telnet path for websockets, but the HTTP update connection request.
